...
//               className="flex items-start gap-2.5 rounded-md text-16px"
//               onClick={onClick}
//             >
//               <div>
...
//                 {transaction?.hashtags?.map((item) => (
//                 <p className="line-clamp-1 text-ellipsis pt-1">{`#${item.name}`}</p>
//                 ))}
//               </div>
//             </Link>
//           ))
...
//   return (
//     <div
//       className="flex cursor-pointer items-start gap-2.5 rounded-md text-16px"
//       onClick={onClick}
//     >
//       <img
...
function SearchUserTransactions({ user, onBack, onClick }) {
  ...
  return (
    <div>
      ...
      <p className="font-font-semibold mt-5 text-18px text-[#00bc9f]">Appriciations</p>
      <div className="space-y-2.5 pt-4">
        {userTransactionQuery.data == null || userTransactionQuery.isLoading ? (
          <div className="space-y-2.5">
            <div className="h-10 w-full animate-pulse rounded-md bg-paper" />
