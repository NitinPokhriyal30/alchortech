    ...
    <div>
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="group relative whitespace-nowrap xs:w-[50%] sm:w-[40%] md:w-[33%] lg:w-fit xxl:w-fit">
          <div className="relative flex items-center font-Lato text-sm text-[#7B7B7B]">
            Sort By:
          ...
          <div className='hidden group-hover:block absolute right-0 z-10 p-2  rounded-md bg-white shadow border child:cursor-pointer'>
            <p className="bg-translucent font-Lato text-sm" onClick={() => onChange('all')}>
              Everything
            </p>
            <p className="bg-translucent font-Lato text-sm" onClick={() => onChange('popular')}>
              Popular
            </p>
            <p className="bg-translucent font-Lato text-sm" onClick={() => onChange('relevant')}>
              Relevant
            </p>
          </div>
        </div>
